...
from finflow.data import HestonParams, generate_heston_dataset
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--no-transitions", action="store_true", help="Only save full paths, not flattened transitions.")
